    ...
    <div class="bg-white min-h-screen font-sans pt-18">
        ...
        <div class="container mx-auto px-4 md:px-12 max-w-7xl lg:px-8 mb-20">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                {{-- KONTEN DESKRIPSI (Kanan) - Mengambil 9 Kolom --}}
                <div class="lg:col-span-9 pl-0 lg:pl-8">
                    ...
                    {{-- Gambar Dokter di bawah konten (Opsional, sesuai kebutuhan) --}}
                    {{-- <div class="mt-10 rounded-xl overflow-hidden shadow-lg h-64 w-full">
        ...
        {{-- SECTION 3: CARI DOKTER (Reused Component) --}}
