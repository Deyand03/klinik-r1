                ...
                <div class="lg:col-span-3">
                    ...
                    <div class="flex flex-col border-t border-gray-200">
                        ...
                        <a href="{{ route('fasilitas.satu') }}"
                            ...
                            <span class="text-[#2B3A55] font-bold text-lg group-hover:pl-1 transition-all">Ruang
                                Tunggu</span>
                        </a>
                        ...
                        <a href="{{ route('fasilitas.dua') }}"
                            class="group flex justify-between items-center py-4 px-2 border-b border-gray-200 hover:text-[#7DD3D5] transition-colors">
                            <span
                                class="text-[#2B3A55] font-bold text-lg group-hover:pl-1 transition-all">Laboratorium</span>
                        </a>
                        ...
                        <a href="{{ route('fasilitas.empat') }}"
                            class="group flex justify-between items-center py-4 px-2 border-b border-gray-200 hover:text-[#7DD3D5] transition-colors">
                            <span class="text-[#2B3A55] font-bold text-lg group-hover:pl-1 transition-all">Farmasi</span>
                        </a>
