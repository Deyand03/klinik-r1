        ...
        <div class="container mx-auto px-4 md:px-12 max-w-7xl lg:px-8 mb-20">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div class="lg:col-span-3">
                    <h3 class="text-[#2B3A55] font-bold text-xl mb-4 uppercase tracking-wide">Fasilitas</h3>
                    ...
                    <div class="flex flex-col border-t border-gray-200">
                        ...
                        <a href="{{ route('fasilitas.satu') }}"
                            ...
                            <span class="text-[#2B3A55] font-bold text-lg group-hover:pl-1 transition-all">Ruang Tunggu</span>
                        </a>

                        <a href="{{ route('fasilitas.dua') }}"
                            class="group flex justify-between items-center py-4 px-2 border-b border-gray-200 hover:text-[#7DD3D5] transition-colors">
                            <span class="text-[#2B3A55] font-bold text-lg group-hover:pl-1 transition-all">Laboratorium</span>
                        </a>
                        ...
                        <a href="{{ route('fasilitas.tiga') }}"
                            ...
                            <span class="text-[#2B3A55] font-bold text-lg">Ruang Tindakan</span>
                        ...
                        <a href="{{ route('fasilitas.empat') }}"
                            class="group flex justify-between items-center py-4 px-2 border-b border-gray-200 hover:text-[#7DD3D5] transition-colors">
                            <span
                                class="text-[#2B3A55] font-bold text-lg group-hover:pl-1 transition-all">Farmasi</span>
                        </a>
                ...
                <div class="lg:col-span-9 pl-0 lg:pl-8">
                    <h1 class="text-[#2B3A55] font-bold text-3xl md:text-4xl mb-6">Ruang Tindakan</h1>
                    ...
                    <div
                        ...
                        <img src="{{asset('img/foto10.jpg')}}" alt="fasilitas Ambulans"
