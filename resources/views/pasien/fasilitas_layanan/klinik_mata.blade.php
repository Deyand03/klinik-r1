        ...
        <div class="container mx-auto px-4 md:px-12 max-w-7xl lg:px-8 mb-20">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div class="lg:col-span-3">
                    ...
                    <div class="flex flex-col border-t border-gray-200">
                        ...
                        <a href="{{ route('fasilitas-layanan.klinik-mata') }}"
                            ...
                            <span class="text-[#2B3A55] font-bold text-lg">Mata</span>
                ...
                <div class="lg:col-span-9 pl-0 lg:pl-8">
                    <h1 class="text-[#2B3A55] font-bold text-3xl md:text-4xl mb-6">Mata</h1>

                    <div class="text-gray-500 text-base leading-relaxed space-y-4 mb-10 text-justify">
                        <p>
                            Layanan pemeriksaan dan perawatan mata secara komprehensif untuk menangani berbagai gangguan
                            penglihatan dan masalah kesehatan mata, ditangani oleh dokter spesialis mata berpengalaman
                            sesuai kebutuhan spesifik Anda.
                        </p>
                        <p>
                            Klinik mata kami didukung teknologi diagnostik modern dan standar keamanan medis yang ketat
                            untuk memastikan hasil pemeriksaan yang akurat serta kenyamanan selama perawatan.
                        </p>
                    </div>
                    ...
                    <ul class="space-y-3 text-gray-500">
                        <li class="flex items-start">
                            ...
                            <span>Pemeriksaan Kesehatan Mata Menyeluruh</span>
                        </li>
                        <li class="flex items-start">
                            <span class="mr-2 text-[#7DD3D5] font-bold text-xl">•</span>
                            <span>Cek Buta Warna</span>
                        </li>
                        <li class="flex items-start">
                            <span class="mr-2 text-[#7DD3D5] font-bold text-xl">•</span>
                            <span>Cek Ukuran Kacamata</span>
                        </li>
                    </ul>
                </div>
            </div>
