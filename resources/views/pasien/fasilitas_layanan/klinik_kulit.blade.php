        ...
        <div class="container mx-auto px-4 md:px-12 max-w-7xl lg:px-8 mb-20">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div class="lg:col-span-3">
                    ...
                    <div class="flex flex-col border-t border-gray-200">
                        ...
                        <a href="{{ route('fasilitas-layanan.klinik-kulit') }}"
                            ...
                            <span class="text-[#2B3A55] font-bold text-lg">Kulit dan Kelamin</span>
                ...
                <div class="lg:col-span-9 pl-0 lg:pl-8">
                    <h1 class="text-[#2B3A55] font-bold text-3xl md:text-4xl mb-6">Kulit dan Kelamin</h1>

                    <div class="text-gray-500 text-base leading-relaxed space-y-4 mb-10 text-justify">
                        <p>
                            Layanan pemeriksaan dan perawatan kulit serta kelamin secara komprehensif untuk membantu Anda
                            mengatasi berbagai masalah kesehatan kulit, rambut, dan organ reproduksi, ditangani oleh dokter
                            spesialis kulit dan kelamin berpengalaman sesuai kebutuhan spesifik Anda.
                        </p>
                        <p>
                            Klinik kami menyediakan diagnosis akurat, terapi medis, serta perawatan estetika dengan standar
                            keamanan dan higienitas yang tinggi untuk memastikan hasil perawatan optimal dan kenyamanan Anda
                    ...
                    <ul class="space-y-3 text-gray-500">
                        <li class="flex items-start">
                            ...
                            <span>Pengobatan jerawat, alergi, dan infeksi kulit</span>
                        </li>
                        <li class="flex items-start">
                            <span class="mr-2 text-[#7DD3D5] font-bold text-xl">•</span>
                            <span>Perawatan estetika</span>
                        </li>
                        <li class="flex items-start">
                            <span class="mr-2 text-[#7DD3D5] font-bold text-xl">•</span>
                            <span>Penanganan rambut rontok dan kulit kepala</span>
                        </li>
                        <li class="flex items-start">
                            <span class="mr-2 text-[#7DD3D5] font-bold text-xl">•</span>
                            <span>Pengobatan penyakit kelamin & infeksi menular seksual</span>
                        </li>
                        <li class="flex items-start">
                            <span class="mr-2 text-[#7DD3D5] font-bold text-xl">•</span>
                            <span>Perawatan flek, bekas jerawat, dan pigmentasi</span>
                        </li>
                    </ul>
                </div>
            </div>
