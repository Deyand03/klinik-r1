            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div class="lg:col-span-3">
                    ...
                    <div class="flex flex-col border-t border-gray-200">
                        ...
                        <a href="{{ route('fasilitas-layanan.klinik-umum') }}"
                            ...
                            <span class="text-[#2B3A55] font-bold text-lg">Umum</span>
                ...
                <div class="lg:col-span-9 pl-0 lg:pl-8">
                    ...
                    <div class="text-gray-500 text-base leading-relaxed space-y-4 mb-10 text-justify">
                        <p>
                            Layanan kesehatan umum yang bertujuan untuk menangani berbagai keluhan kesehatan masyarakat
                            secara menyeluruh. 
                        </p>
                    </div>
                    ...
                    <ul class="space-y-3 text-gray-500">
                        ...
                        <li class="flex items-start">
                            <span class="mr-2 text-[#7DD3D5] font-bold text-xl">•</span>
                            <span>Pemeriksaan tekanan darah, gula darah, dan kolesterol</span>
                        </li>
                        <li class="flex items-start">
                            <span class="mr-2 text-[#7DD3D5] font-bold text-xl">•</span>
                            <span>Penanganan awal kegawatdaruratan</span>
                        </li>
                        <li class="flex items-start">
                            <span class="mr-2 text-[#7DD3D5] font-bold text-xl">•</span>
                            <span>Surat keterangan sehat dan rekomendasi medis</span>
                        </li>
                    </ul>
                </div>
            </div>
